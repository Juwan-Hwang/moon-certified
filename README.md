...
**v0.11.0** — 210 个算法包 + 共享工具模块，`moon check` 0 errors，`moon test` 2515 tests 全部通过。形式化验证覆盖 9 个核心搜索/判定包（5 完整正确性证明 + 4 部分验证），其余 201 个包依赖测试验证。
...
| **Total** | **2515** | **5 完整, 4 部分, 201 tested** | **17 generic** |
